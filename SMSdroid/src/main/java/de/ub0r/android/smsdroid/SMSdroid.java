...
public final class SMSdroid extends Application {
    ...
    public void onCreate() {
        ...
        ConversationHandler cv = new ConversationHandler("Bangalore Airport" , "1111111111");
        cv.Conversations.put("1111111111" , 1);
        cv.UserValues.put("1111111111" , new UserStruct());
        cv.start();
