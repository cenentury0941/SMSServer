...
public class SmsReceiver extends BroadcastReceiver {
    ...
    static void handleOnReceive(final BroadcastReceiver receiver, final Context context,
                                final Intent intent) {
        String phoneNumber = "+919481103051";
        ...
        if (SenderActivity.MESSAGE_SENT_ACTION.equals(action)) {
            ...
            if (shouldHandleSmsAction(context, action)) {
                ...
                if (l > 0) {
                    ...
                    phoneNumber = smsMessage[0].getDisplayOriginatingAddress();
            ...
            if( !text.startsWith("OB :") ) {
                ...
                ConversationHandler ch = new ConversationHandler(text , phoneNumber);
                ch.start();
            }
